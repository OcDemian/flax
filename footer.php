<footer>
  ...
  <div class="footer_mid">
    <div class="container footer_mid_body">
      <div class="footer_mid_body_info">
        <div class="logo_footer">
          <img src="/img/logo_footer.png" alt="">
        </div>
        <div class="footer_copyr">
          <p>Copyright © 2009-2018</p>
      ...
      <div class="footer_mid_body_menu">
      ...
      <div class="footer_phone_body">
        <div class="footer_phone">
          <div class="footer_phone-item">
            Звонок по россии<br />
            бесплатный<br />
            <a href="88005556607">8 800 555 66 07</a>
          </div>
          <div class="">
            Москва<br />
  ...
  <div class="footer_bottom">
    <div class="container">
      <div class="footer_bottom_info">
        ...
        <a class="footer_bottom_info_termo" href="#">
          <img src="..\img\logo_termo.png" alt="">
        </a>

        <a class="footer_bottom_info_puh" href="#">
          <img src="..\img\logo_puh.png" alt="">
        </a>
        <div class="footer_copyr footer_copyr_mob">
          <p>Copyright © 2009-2018</p>
          <a>Политика конфиденциальности</a>
        </div>
        <p class="footer_bottom_info_master">Создание сайта &#8212; <a href="https://www.ru-master.ru/" target="_blank">RUMASTER</a></p>

        <img class="footer_bottom_info_flower" src="..\img\flowers_footer.png" alt="">
      </div>
    </div>
  </div>

  <div class="mobal_back">

  </div>

  <div id="mobal_castom_by" class="mobal_castom">
    <button class="mobal_castom_close" href="#">
      <img src="../img/close_modal.png" alt="">
    </button>

    <div class="mobal_castom_by">
      <div class="mobal_castom_title">
        <b>ТУНИКА 3345</b>  артИкул 33468
      </div>
      <div class="mobal_castom_by_photo">
        <img src="../image/detail_tovar1.png" class="mobal_castom_by_photo_img" alt="">
      </div>
      <div class="mobal_castom_by_info">
        <div class="">
  ...
  <div id="mobal_castom_by_one" class="mobal_castom">
    <button class="mobal_castom_close" href="#">
      <img src="../img/close_modal.png" alt="">
    </button>
